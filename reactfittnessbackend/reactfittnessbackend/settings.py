"""
Django settings for reactfittnessbackend project.
...
SECRET_KEY = 'zc9lzw=b0^8mq1lyljz(8j%o7$^ud7kn1if8@3*ff^!nzmr%yy'
...
ROOT_URLCONF = 'reactfittnessbackend.urls'
...
WSGI_APPLICATION = 'reactfittnessbackend.wsgi.application'
